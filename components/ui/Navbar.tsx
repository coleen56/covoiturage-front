                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        <form>
                            <button
                                ...
                                type="submit"
                                className="flex flex-row relative space-x-2 rounded-full p-1 text-gray-400 hover:text-red-700 hover:cursor-pointer focus:outline-2 focus:outline-offset-2 focus:outline-indigo-500"
                            >
